/* create a program that extracts data from the preceding JSON in the following format:
 [
...
var input={
    ...
    //considering only the articles//
    var var1 = input["articles"];
    
    for(var i=0;i<var1.length;i++){
        //delete method to delete the particular object//
        delete(var1[i].url);
